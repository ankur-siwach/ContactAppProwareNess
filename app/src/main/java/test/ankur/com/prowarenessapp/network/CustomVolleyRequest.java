package test.ankur.com.prowarenessapp.network;
...
public class CustomVolleyRequest<T> extends JsonRequest<T> {
     ...
     */
    private CustomVolleyRequest(int method, Class<T> classType, String url, String requestBody,
     ...
     * @param headers:       Added headers
     */
    public CustomVolleyRequest(int method, String url, Class<T> classType, Object toBeSent,
                               Response.Listener<T> listener, Response.ErrorListener errorListener, Map<String, String> headers) {
     ...
     * @param errorListener: Error handler of the request
     */
    public CustomVolleyRequest(int method, String url, Class<T> classType, String requestBody,
                               Response.Listener<T> listener, Response.ErrorListener errorListener) {
     ...
     * @param errorListener: Error handler of the request
     */
    public CustomVolleyRequest(String url, Class<T> classType, Response.Listener<T> listener, Response.ErrorListener errorListener) {
        this(Method.GET, url, classType, "", listener, errorListener);
    }
     ...
     * @param headers:       Added headers
     */
    public CustomVolleyRequest(String url, Class<T> classType, Response.Listener<T> listener, Response.ErrorListener errorListener, Map<String, String> headers) {
        this(Method.GET, classType, url, "", listener, errorListener, headers);
    }
